...
sequential='^(BenchmarkTransformBigClaudeCode|BenchmarkTransformAnthropicMessages|BenchmarkCachePrefixDigest|BenchmarkHistoryImageSha8|BenchmarkRenderDensePage|BenchmarkTransformOpenAIChat|BenchmarkTransformOpenAIResponses|BenchmarkAnthropicResponseScannerJSON|BenchmarkAnthropicResponseScannerSSE)$'
